...
This repository contains the **mobile app** component of the AssetsX project. A companion web app (built separately by a teammate) is available at [assetsx-web.vercel.app](https://assetsx-web.vercel.app), and the mobile app links directly to it from the Markets screen.

> Built as part of the **Frontend Programming** and **IT Agile Development** modules at the University of Europe for Applied Sciences (UE Berlin).
